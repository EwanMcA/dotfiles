...
# kubectl exec -n clients pod -- tar czf - <path_on_pod> > <path_on_local>
# kubectl exec -n clients milvus-writable-78875968f-56xw6 -- tar czf - /var/lib/milvus/db > ../milvusdb.tar.gz
#
...
# overwrite this function from ohmyzsh to keep termtitle as pwd when in vim
function omz_termsupport_preexec {
  return
}
ZSH_THEME_TERM_TITLE_IDLE="%~ %j"
...
vimAg() {
  nvim `ag $1 -c | cut -f 1 -d :`
}

standup() {
  yesterday=$(date -d "yesterday" +"%Y-%m-%d")
  sed -i "s/^## standup$/## standup\n\n## $yesterday/" "/home/emcandrew/Documents/notes/TODO.md"
}
